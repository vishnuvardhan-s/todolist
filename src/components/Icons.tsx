export const TodoIcon = () => <span className="h-5 w-5 ml-2 bg-white border border-black border-solid rounded-full inline-block"></span>;
export const DoneIcon = () => <span className="h-5 w-5 bg-black rounded-full inline-block"></span>;
